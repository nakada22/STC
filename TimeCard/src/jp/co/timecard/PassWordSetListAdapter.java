...
public class PassWordSetListAdapter extends ArrayAdapter<HashMap<String, String>>{
    private LayoutInflater li;
    private TextView tv_title;
    private TextView tv_ini;

    public PassWordSetListAdapter(Context context, List<HashMap<String, String>> objects)
    {
